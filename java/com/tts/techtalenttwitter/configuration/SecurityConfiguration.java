...
//	// web WebSecurityConfigurerAdapter is a configuration class that 
//	// is provided by Spring Security and by defaults sets spring 
//	// security up in a locked down configuration. by inherihiting 
//	//it and overring certain methods
...
//		auth.jdbcAuthentication()// we want to use database authentication
//		
...
//	 .and()	
//	 	.formLogin()// tellls SpringSecurity that we are going to login using web page
//	 		.loginPage("/login")
